...
const UserOnboarding = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('/api/user/onboard', {
        ...
        body: JSON.stringify({ koreanName, birthdate, gender, role, grade: role === 'STUDENT' ? grade : null }),
      })
      ...
      await update({ koreanName, birthdate, gender, role, grade: role === 'STUDENT' ? grade : null })
  ...
  return (
    <motion.div
      ...
      className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-b from-slate-950 via-indigo-950 to-slate-900 p-4"
    >
