...
export default function PrincipalPage() {
  return (
    <ContentPageLayout
      ...
      subtitle="A warm welcome from our school leader."
    ...
    >
      <section className="max-w-5xl mx-auto py-12">
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <Image src="/images/principal.jpg" alt="Principal" width={288} height={288} className="rounded-xl w-full object-cover shadow-lg" />
