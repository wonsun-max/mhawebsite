...
export default function EditAlbumPage() {
    ...
    return (
        <div>
            ...
            <h1 className="text-3xl font-bold text-white mb-2">앨범 수정</h1>
            <p className="text-gray-400 mb-8">앨범 정보와 이미지를 수정하세요</p>
                ...
                <div className="mb-6">
                    ...
                    >
                        ...
                        <label htmlFor="file-upload" className="cursor-pointer">
                            ...
                            <p className="text-white font-medium mb-1">새 이미지 추가</p>
